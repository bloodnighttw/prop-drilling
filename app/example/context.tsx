...
export function useSharedContext() {
    ...
    if (!contextValue) {
        throw new Error("useSharedContext must be used within a SharedProvider, please wrap your component tree with <SharedProvider>.");
    }
    return contextValue;
}
...
export function GrandChild() {
    ...
    return (
        <RandomBackgroundColorBlock>
            ...
            <button onClick={() => setThemeValue(themeValue === "light" ? "dark" : "light")}>
                Toggle Theme
            </button>
        </RandomBackgroundColorBlock>
    );
